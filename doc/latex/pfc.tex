...
\lstset{inputencoding=utf8/latin1}
\lstinputlisting[language=C++]{../src/manifest_example.xml}
...
\lstset{inputencoding=utf8/latin1}
\lstinputlisting[language=C++]{../../doc/src/arm_visualizer_example.cpp}
...
%\section{Utilización de los datos obtenidos para el control de la simulación del modelo de un brazo humano}
...
\begin{figure}
	\centering
		\includegraphics[scale=0.4]{../img/gazebo_delete_2b.png} 
...
\item También será necesario poner la simulación en pausa, ya que de otra manera se realizará la simulación de la gravedad sobre el brazo y se obtendrán resultados no deseados (figura \ref{fig: gazebo_pause}).
